...
<div class="div01">
                    ...
                    <h1 style="margin-left:60px;margin-top: 40px;">Add User : </h1>
                    <hr>
...
<option value="Admin">Admin</option>
                    ...
                    <br>
                       ...
                       <input type="submit" value="Add User "  style="background-color:red;color:white;text-decoration:none;font-size:20px;margin-left:50px;padding:16px 100px;border: 1px;border-radius:60px"></form>
